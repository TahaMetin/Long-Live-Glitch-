...
public class SavunanObjeleriOlustur : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        savunanObjeParent = GameObject.Find("savunanlarr");
    ...
    private void Objeyiolustur(GameObject olusacakSavunacakObjemiz,Vector2 gercekDunyaPozisyonunuYukariYuvarlamamiz)
    {
